/* Minimal service worker: makes the app installable and lets the
   app shell load even with a flaky connection. It does not try to
   cache Supabase API calls or the Google Fonts / Supabase CDN
   scripts — those still need network, exactly like today. */
const CACHE_NAME = "personality-mindmap-shell-v1";
